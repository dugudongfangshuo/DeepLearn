...
# 参考链接：https://colab.research.google.com/drive/1fdqTk4CTXNcrcSVFvaOKzRfLmj4fJfwa?usp=sharing
class SEBrain(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        # 将混合噪音的特征图谱放入到模型中学习去除噪音特征的mask,输出同样大小的矩阵后和原始噪音矩阵对应位置相乘，以mask掉噪音信息
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        loss = sb.nnet.losses.mse_loss(predictions["spec"], clean_spec)
...
if __name__ == "__main__":
    ...
    # # print(run_opts)
    # # print(overrides)
    # run_opts = {'debug': False, 'debug_batches': 2, 'debug_epochs': 2, 'device': 'cuda:0', 'data_parallel_count': -1, 'data_parallel_backend': False, 'distributed_launch': False, 'distributed_backend': 'nccl', 'auto_mix_prec': False, 'noprogressbar': False}
